"""
Django settings for yvcdhd_363 project.
...
WSGI_APPLICATION = 'yvcdhd_363.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yvcdhd_363 API",
    "DESCRIPTION": "API documentation for yvcdhd_363 App",
    "VERSION": "v1",
}
